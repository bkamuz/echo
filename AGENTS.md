...
- Closing the main window should minimize to the tray; tray context menu should cover open, settings, history, and exit; tray Exit must shut down promptly (no multi-minute hang on Windows).
